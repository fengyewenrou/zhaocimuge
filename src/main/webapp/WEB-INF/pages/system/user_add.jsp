...
<div class="ibox-content"  >
  <form class="form-horizontal m-t" id="commentForm" action="<%=basePath%>/sysUser/save.html">
    <div class="col-md-6">
        ...
        <div class="col-sm-5">
          <select class="form-control" name="roleId">
            <c:forEach items="${sysRoles}" var="sysRoles">
              <option value="${sysRoles.roleId}" >${sysRoles.roleDesc}</option>
            </c:forEach>
          </select>
        </div>
      </div>
    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input id="userPassword" type="password" class="form-control" required="required" name="userPassword">
        </div>
      </div>
    </div>
    <div class="col-md-6">
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input id="mobile" name="mobile"maxlength="11" type="text"   class="form-control"   >
        </div>
      </div>
      <div class="form-group">
