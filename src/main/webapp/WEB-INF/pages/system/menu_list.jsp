...
<div class="wrapper wrapper-content animated fadeInRight" data-width="100%">
  <div class="row">
    <div class="col-sm-12">
      <form action="<%=basePath%>/menu/list.html" method="post" id="subform">
      <div class="ibox-tools">
        <span>菜单名称:</span> <input type="text" id="menuName" name="p_menuName" value="${page.params["menuName"] }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <span>父节点:</span> <input type="text" id="parentCode" name="p_parentCode" value="${page.params["parentCode"] }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <a class="btn btn-primary btn-sm" title='添加' href="<%=basePath%>/menu/add.html"><i class="fa fa-plus"></i>添加</a>
      </div>
...
<table id="example" class="display nowrap" cellspacing="0" width="100%">
  ...
  <c:forEach items="${page.resultList}" var="row" varStatus="status">
    <tr class="gradeC">
      ...
      <td style="text-align: center"><a class="btn btn-primary btn-sm cc"  href="<%=basePath%>/menu/${row.id}/edit.html"><i class="fa fa-edit"></i> 编辑</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary btn-sm cc"    href="<%=basePath%>/menu/${row.id}/del.html"><i class="fa fa-delicious"></i> 删除</a></td>
    </tr>
  </c:forEach>
  </tbody>
</table>
