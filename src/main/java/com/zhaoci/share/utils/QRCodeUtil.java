...
public class QRCodeUtil {
    ...
    public static void main(String[] args) throws Exception {  
        String text_local = "http://192.168.30.51:9090/share/other/register_local.html?platform=ios&channel=offxm001";  
        String text_pre= "http://139.196.24.16/share/other/register_local.html?platform=ios&channel=offxm001";  
        String text= "http://www.p-share.com/share/other/register_local.html?platform=ios&channel=offxm001";  
        QRCodeUtil.encode(text_local, "d:/tmp/logo2.png", "d:/tmp/text_local.jpg", true);  
        QRCodeUtil.encode(text_pre, "d:/tmp/logo2.png", "d:/tmp/text_pre.jpg", true);  
        QRCodeUtil.encode(text, "d:/tmp/logo2.png", "d:/tmp/text.jpg", true);  
    }  
}
